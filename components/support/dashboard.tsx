...
export function SupportDashboard() {
  return (
    <div className="flex h-dvh min-h-0 min-w-0 flex-col overflow-hidden bg-muted/30">
      <header className="flex shrink-0 items-center gap-2 border-b border-border bg-card px-3 py-2.5 sm:gap-3 sm:px-5 sm:py-3">
        ...
        <div className="ml-auto flex shrink-0 items-center gap-1.5 sm:gap-2">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex size-9 items-center justify-center rounded-md border border-border bg-background transition-colors hover:bg-accent sm:h-9 sm:w-auto sm:gap-2 sm:px-3 sm:text-sm sm:font-medium"
          ...
          >
            ...
            <ExternalLinkIcon className="hidden size-3.5 opacity-70 md:block" />
          </a>
      ...
      >
        <div className="shrink-0 overflow-x-auto border-b border-border bg-card px-2 sm:px-5">
          <TabsList
            variant="line"
            className="h-auto min-w-max p-0"
          >
            <TabsTrigger
              value="ai"
              className="flex-none gap-2 px-3 py-3 text-foreground/70 data-active:text-primary"
